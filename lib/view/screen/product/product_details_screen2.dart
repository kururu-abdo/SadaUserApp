...
final bool? isFromCart;
  ...
  ProductDetails2({required this.product, 
  
  this.isFromCart=false ,
  this.id ,this.slug  , this.seller});
...
class _ProductDetailsState extends State<ProductDetails2> {
  ...
  FirebaseAnalytics.instance.logEvent(
    ...
    parameters: {
      ...
      Provider.of<ProductDetailsProvider>(context, listen: false).getCount(
         widget.product==null?
          widget.id!:
          widget.product!.id.toString(), context);
...
SafeArea(
  child:   Scaffold(
    ...
    backgroundColor: Theme.of(context).primaryColor,
        ...
        bottomNavigationBar: 
        widget.isFromCart!?SizedBox.shrink():
