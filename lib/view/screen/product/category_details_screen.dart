...
import 'package:eamar_user_app/data/model/response/category.dart' as cat;
...
class _BrandAndCategoryProductScreenState extends State<CategoryDetailsScreen> {
...
//             ) : 
      ...
      builder: (context, categoryProvider, child)  {
                return Visibility(
                  ...
                  child: categoryProvider.subCategroies.length != 0 ?
                       ListView.builder(
      ...
      builder: (context, categoryProvider, child)  {
          ...
          return        Visibility(
                    visible:   categoryProvider.subSubCategroies.length>0,
                    child: SizedBox(
                    height: 
                           MediaQuery.of(context).size.height/6 ,
                      child: AnimatedOpacity( child:  
             ...
             Expanded(
              child: StaggeredGridView.countBuilder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  productProvider.brandOrCategoryProductList[index]);
                },
              ),
            ) :
