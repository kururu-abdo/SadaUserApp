...
import 'package:eamar_user_app/view/basewidget/shimmer_loading.dart';
import 'package:eamar_user_app/view/screen/chat/chat_screen.dart';
import 'package:eamar_user_app/view/screen/seller/seller_screen.dart';
...
import 'package:eamar_user_app/view/basewidget/amount_widget.dart';
...
import 'package:eamar_user_app/view/screen/order/widget/order_details_widget.dart';
import 'package:eamar_user_app/view/screen/payment/payment_screen.dart';
import 'package:eamar_user_app/view/screen/support/support_ticket_screen.dart';
import 'package:eamar_user_app/view/screen/tracking/tracking_screen.dart';
                        ...
                        children: [
                          ...
                          Row(mainAxisAlignment:MainAxisAlignment.start, crossAxisAlignment:CrossAxisAlignment.start,
                              children: [
                                ...
                                Expanded(child: Text(' ${orderModel !=null  && orderModel!.shippingAddressData != null ?
                                orderModel!.shippingAddressData!.address :''}', maxLines: 3, overflow: TextOverflow.ellipsis,
                    ...
                    Padding(padding : EdgeInsets.all(Dimensions.MARGIN_SIZE_SMALL),
                      child: Text.rich(
                        TextSpan(children: [
                          ...
                          TextSpan(text:  '${orderModel!.orderNote != null? orderModel!.orderNote ?? '': ""}',
                              style: titilliumRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL)),
                          ],
                        ),
                      ),
                          ...
                          children: [
                            ...
                            AmountWidget(title: getTranslated('TOTAL_PAYABLE', context),
                              amount: PriceConverter.convertPrice(context,
                                  (_order + _shippingFee! +order.trackingModel!.shippingCost! - eeDiscount! -
