...
import 'package:eamar_user_app/data/model/response/transaction_model.dart';
...
import 'package:eamar_user_app/view/screen/wallet/widget/transaction_widget.dart';
    ...
    scrollController?.addListener(() {
      if(scrollController!.position.maxScrollExtent == scrollController!.position.pixels
        ...
        if(offset < pageSize!) {
          ...
          Provider.of<WalletTransactionProvider>(context, listen: false).getTransactionList(context, offset);
        }
      }
