...
class NewArrivalsProductView extends StatelessWidget {
  final bool isHomePage;
  final ProductType productType;
  final ScrollController? scrollController;
  final String? sellerId;
  NewArrivalsProductView({required this.isHomePage, required this.productType, this.scrollController, this.sellerId});
  ...
  Widget build(BuildContext context) {
    ...
    //       pageSize =
    //        (Provider.of<ProductProvider>(context, listen: false).arrivalPageSize!/10).ceil();
    ...
    return Consumer<ProductProvider>(
      builder: (context, prodProvider, child) {
        ...
        // if(productType == ProductType.LATEST_PRODUCT) {
          productList = prodProvider.newArrivalsProducts;
        // }
