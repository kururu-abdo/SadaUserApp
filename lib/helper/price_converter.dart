...
class PriceConverter {
  ...
  {double? discount, String? discountType}) {
    ...
    '${price!.toStringAsFixed(2)}';
        ...
        // * (1/Provider.of<SplashProvider>(context, listen: false).usdCurrency!.
        // exchangeRate!)).toStringAsFixed(Provider.of<SplashProvider>(context,listen: false).
        // configModel!.decimalPointSetting??1).replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'),
        //  (Match m) => '${m[1]},')}'
